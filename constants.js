...
export const THEMES = {
  light: {
    ...
    // ★ カード：料理写真が映える白
    cardBg: '#FFFFFF',
    // ★ ヘッダー：ロゴ画像（#F8EBD8）と完全に同一化
    headerBg: '#F8EBD8',
    // ★ 文字色：ロゴに調和する深いエスプレッソブラウン
    textMain: '#3E2723',
    textSub: '#5D4037',
    textMuted: '#8D6E63',
    // ★ 境界線：温かみのあるビスケットベージュ
    ...
    borderInput: '#DECAB1',
    inputBg: '#FFFDF9',
    // ★ メインアクセント：Meppyの双葉に合わせた温かいオレンジ
    primary: '#D35400',
    primaryLight: '#FDF0E2',
    primaryBorder: '#F5D2B3',
    chipBg: '#F5E7D3',
    navBg: '#F8EBD8', // 下部ナビゲーションバーもヘッダーと同一色で統一
  ...
  dark: {
    ...
    borderInput: '#404040',
    inputBg: '#2A2A2A',
    primary: '#FF8A65', // ダークモードでも温かいテラコッタ
    primaryLight: '#3E2723',
